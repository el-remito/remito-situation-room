...
import { threadRemoval } from '../scripts/logic/removal.mjs';
import {
...
const BOARD = {
    ...
    nodes: [
        ...
        normalizeNode({ id: 'n2', plotId: 'p1', name: 'Sack the Granary', prereqNodeIds: ['n1'] }),
        ...
        normalizeNode({
            ...
            prereqNodeIds: ['n1'], status: NODE_STATUS.CONCLUDED
        }),
